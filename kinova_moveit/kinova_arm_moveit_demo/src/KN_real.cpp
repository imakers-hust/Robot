...
//moveit::planning_interface::MoveGroupInterface arm_group("manipulator");//改为全局变量，方便机械臂运动规划的使用
...
float openVals_real[10]={0.450, 0.550, 0.500, 0.450, 0.450, 0.450, 0.450, 0.500, 0.550, 0.400};// 针对实物的爪子张开程度
